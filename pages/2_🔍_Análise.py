...
with col2:
    ...
    Para melhor entender o impacto da Passos Mágicos, é necessário contextualizar o cenário socioeconômico e educacional da região em que ela atua.
    ...
    Já no segundo painel, o objetivo é destrinchar os dados disponibilizados pela Passos Mágicos no âmbito dos projetos de Pesquisa Extensiva do Desenvolvimento Educacional, dos anos de 2020, 2021 e 2022. São apresentados indicadores relacionados
